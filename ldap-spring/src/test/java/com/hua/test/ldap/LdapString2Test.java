...
@ContextConfiguration(locations = {"classpath:conf/xml/spring-config.xml", "classpath:conf/xml/spring-ldap2.xml"})
public final class LdapString2Test extends BaseTest {
