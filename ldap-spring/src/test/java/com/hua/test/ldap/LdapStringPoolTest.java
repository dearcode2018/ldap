...
@ContextConfiguration(locations = {"classpath:conf/xml/spring-config.xml", "classpath:conf/xml/spring-ldap-pool.xml"})
public final class LdapStringPoolTest extends BaseTest {
